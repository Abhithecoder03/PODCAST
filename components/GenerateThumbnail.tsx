    ...
    <>
      ...
      {isAiThumbnail ? (<div className='flex flex-col gap-5 '>
        <div className='mt-5 flex flex-col gap-2.5'>
          ...
          <Button type="submit" className="text-16  bg-orange-1 py-4 font-extrabold text-white-1" onClick={generateImage}>
              {isImageLoading ? <>
                                Generating
      ...
      </div>) : (<div className='image_div ' onClick={() => {
      ...
      imageRef?.current?.click()}}>
          ...
          <div className='flex flex-col gap-1 items-center'>
            ...
            <p className='text-12 font-normal text-gray-1'> SVG , PNG , JPG or GIF (max, 1000x1000px)</p>
          </div>
      </div>)}
